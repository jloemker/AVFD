...
echo "mkdir -p /data/alice/jlomker/AVFD/tau_init0.4/BField0.4/Centrality-$centID/dirID-$dirID"
echo "cd /data/alice/jlomker/AVFD/tau_init0.4/BField0.4/Centrality-$centID/dirID-$dirID"
echo "pwd"
echo "if [ -f *.root ]"
echo "  then "
echo "rm -rf *.root"
