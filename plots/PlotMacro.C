...
Del_vn_01->GetYaxis()->SetTitle(DelY);
Del_vn_01->GetXaxis()->SetTitle("#eta");
Del_vn_01->SetLineColor(kGreen+3);
Del_vn_01->GetXaxis()->SetRangeUser(-0.9,0.9);
Del_vn_01->GetXaxis()->SetTitleOffset(2.0);
Del_vn_01->Draw();
/*
...
Del_vn_11->GetYaxis()->SetTitle(DelY);
Del_vn_11->GetXaxis()->SetTitle("#eta");
Del_vn_11->SetLineColor(kGreen+3);
Del_vn_11->GetXaxis()->SetRangeUser(-3.1,3.1);
Del_vn_11->GetXaxis()->SetTitleOffset(2.0);
Del_vn_11->Draw();
/*
